...
function my_keydown() {
    ...
    if ((keypress>=97 && keypress<=122)|| (keypress>=65 && 90)) {
        alphabetkey()
        document.getElementById("d1").innerHTML="You pressed on an alphabet key"
...
window.addEventListener("keydown1",keydown1)
function keydown1() {
    keypress1=e.keyCode;
    console.log("keypress1");
    if (keypress1=47-56) {
        numberkey()
        document.getElementById("d1").innerHTML="You pressed on a number key"
...
window.addEventListener("keydown2",keydown2)
function keydown2() {
    keypress2=e.keyCode;
    console.log("keypress2");
    if (keypress2=36-41) {
        arrowkey()
        document.getElementById("d1").innerHTML="You pressed on a arrow key"
...
window.addEventListener("keydown3",keydown3)
function keydown3() {
    keypress3=e.keyCode;
    console.log("keypress3");
    if (keypress3=17,18,27) {
        specialkey()
        document.getElementById("d1").innerHTML="You pressed on a ctrl,alt,esc keys"
